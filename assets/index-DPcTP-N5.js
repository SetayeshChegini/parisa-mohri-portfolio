...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ja(e,t,n){let r=new Float32Array(Pa),i=new W(0,1,0);return new wi({name:`SphericalGaussianBlur`,defines:{n:Pa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Za(),fragmentShader:`
	...
	`}var Qa=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function Bc({mediaType:e=`image`,image:t={src:`https://framerusercontent.com/images/GfGkADagM4KEibNcIiRUWlfrR0.jpg`,alt:`Image`},video:n=``,grid:r=16,mouse:i=.12,strength:a=.15,relaxation:o=.9,hoverMultiplier:s=1.5,background:c=`#000000`,dprCap:l=2,assemble:u=!0,className:d=``,style:f}){let p=_.useRef(null),m=_.useRef(null),h=_.useRef(null),g=_.useRef(null),v=_.useRef(null),y=_.useRef(null),x=_.useRef(null),S=_.useRef(1),C=_.useRef(!1),w=_.useRef(u);_.useEffect(()=>{w.current=u},[u]);let E=_.useRef({x:0,y:0,prevX:0,prevY:0,vX:0,vY:0});return _.useEffect(()=>{if(!p.current)return;let o=p.current,c=new Pn,u=new Ic({antialias:!0,alpha:!0,powerPreference:`high-performance`});u.setClearColor(0,0),u.setPixelRatio(Math.min(window.devicePixelRatio,l)),o.appendChild(u.domElement),m.current=u;let d=new na(0,0,0,0,-1e3,1e3);d.position.z=2,h.current=d;let f={time:{value:0},resolution:{value:new Gt},uTexture:{value:null},uDataTexture:{value:null},uAssembly:{value:+!!w.current},uGrid:{value:Math.max(2,Math.floor(r))}};x.current=f;function _(){let e=o.clientWidth||1,t=o.clientHeight||1;u.setSize(e,t);let n=e/t,r=S.current,i=Math.max(n/r,1);g.current&&g.current.scale.set(r*i,i,1);let a=1*n;d.left=-a/2,d.right=a/2,d.top=1/2,d.bottom=-1/2,d.updateProjectionMatrix(),f.resolution.value.set(e,t,1,1)}let D=null,O=null,ee=()=>new Promise(e=>{new qi().load(t.src,t=>{t.minFilter=T,t.magFilter=T,t.wrapS=b,t.wrapT=b;let n=t.image;S.current=(n.width||1)/(n.height||1),f.uTexture.value=t,O=t,e()})}),k=()=>new Promise(e=>{let t=document.createElement(`video`);t.src=n,t.loop=!0,t.muted=!0,t.autoplay=!0,t.playsInline=!0,t.crossOrigin=`anonymous`,y.current=t,t.addEventListener(`loadedmetadata`,()=>{let e=t.videoWidth||16,n=t.videoHeight||9;S.current=e/Math.max(n,1),_()},{once:!0}),t.play().catch(()=>{console.warn(`Autoplay blocked, requiring user interaction`),o.addEventListener(`click`,()=>t.play(),{once:!0})}),D=new li(t),D.minFilter=T,D.magFilter=T,D.wrapS=b,D.wrapT=b,D.needsUpdate=!0,f.uTexture.value=D,S.current=16/9,e()}),A=async()=>{e===`video`&&n?await k():await ee(),_()},j=Math.max(2,Math.floor(r)),te=new Float32Array(4*j*j),re=new Float32Array(4*j*j);for(let e=0;e<j*j;e++)re[e*4+0]=(Math.random()-.5)*12,re[e*4+1]=(Math.random()-.5)*12,te[e*4+0]=w.current?0:re[e*4+0],te[e*4+1]=w.current?0:re[e*4+1],te[e*4+2]=0,te[e*4+3]=1;let M=new ei(te,j,j,F,ne);M.needsUpdate=!0,v.current=M,f.uDataTexture.value=M;let N=new wi({side:2,uniforms:f,vertexShader:Rc,fragmentShader:zc,transparent:!0}),ie=new hi(1,1,j-1,j-1),ae=new Zr(ie,N);c.add(ae),g.current=ae;let oe=e=>{let t=o.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=1-(e.clientY-t.top)/t.height;E.current.vX=n-E.current.prevX,E.current.vY=r-E.current.prevY,E.current.prevX=n,E.current.prevY=r,E.current.x=n,E.current.y=r},P=()=>{C.current=!0},se=()=>{C.current=!1,E.current={x:0,y:0,prevX:0,prevY:0,vX:0,vY:0}};o.addEventListener(`mousemove`,oe),o.addEventListener(`mouseenter`,P),o.addEventListener(`mouseleave`,se),window.addEventListener(`resize`,_),A();let I=0,ce=()=>{I=requestAnimationFrame(ce),f.time.value+=.05,D&&(D.needsUpdate=!0),w.current&&(f.uAssembly.value+=(1-f.uAssembly.value)*.055);let e=M.image.data,t=j*j;if(w.current)for(let n=0;n<t;n++)e[n*4+0]*=.925,e[n*4+1]*=.925;if(w.current&&C.current){let t=a*100*s,n=j*E.current.x,r=j*E.current.y,o=j*i;for(let i=0;i<j;i++)for(let a=0;a<j;a++){let s=n-i,c=r-a,l=s*s+c*c;if(l<o*o&&l>1e-4){let n=4*(i+j*a),r=Math.min(o/Math.sqrt(l),10);e[n+0]+=t*E.current.vX*r,e[n+1]-=t*E.current.vY*r}}}M.needsUpdate=!0,u.render(c,d)};return ce(),()=>{if(cancelAnimationFrame(I),o.removeEventListener(`mousemove`,oe),o.removeEventListener(`mouseenter`,P),o.removeEventListener(`mouseleave`,se),window.removeEventListener(`resize`,_),ie.dispose(),ae.material.dispose(),M.dispose(),O&&O.dispose(),D&&D.dispose?.(),y.current)try{y.current.pause(),y.current.removeAttribute(`src`),y.current.load()}catch{}u.dispose(),u.domElement&&u.domElement.parentNode&&u.domElement.parentNode.removeChild(u.domElement)}},[e,t.src,n,r,i,a,o,s,l]),(0,Z.jsx)(`div`,{ref:p,className:d,style:{width:`100%`,height:`100%`,background:c,cursor:`pointer`,...f},role:`img`,"aria-label":e===`image`?t.alt||`Grid Distortion`:`Distorted video`})}function Vc(){let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!0);return(0,_.useEffect)(()=>{let e=document.body.style.overflow,n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,i=n?320:1500,o=performance.now(),s=0,c=0,l=0;document.body.style.overflow=`hidden`;let u=d=>{let f=Math.min(100,Math.round((d-o)/i*100));if(t(f),f<100){s=requestAnimationFrame(u);return}c=window.setTimeout(()=>r(!0),n?60:180),l=window.setTimeout(()=>{a(!1),document.body.style.overflow=e},n?180:700)};return s=requestAnimationFrame(u),()=>{cancelAnimationFrame(s),clearTimeout(c),clearTimeout(l),document.body.style.overflow=e}},[]),i?(0,Z.jsxs)(`div`,{className:`preloader${n?` preloader--exiting`:``}`,role:`status`,"aria-live":`polite`,"aria-label":`Loading portfolio, ${e}%`,children:[(0,Z.jsxs)(`div`,{className:`preloader__content`,children:[(0,Z.jsx)(`span`,{className:`preloader__label`,"data-text":`LOADING`,children:`LOADING`}),(0,Z.jsxs)(`strong`,{className:`preloader__progress`,"data-text":`${e}%`,children:[e,`%`]})]}),(0,Z.jsx)(`div`,{className:`preloader__track`,"aria-hidden":`true`,children:(0,Z.jsx)(`span`,{style:{transform:`scaleX(${e/100})`}})})]}):null}function Hc({image:e}){return(0,Z.jsxs)(`section`,{className:`about-section`,id:`profile`,"aria-labelledby":`about-title`,children:[(0,Z.jsxs)(`p`,{className:`section-label`,id:`about-title`,children:[`About `,(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`>`})]}),(0,Z.jsx)(`div`,{className:`about-image-wrap`,children:(0,Z.jsx)(Bc,{mediaType:`image`,image:{src:e,alt:`Parisa Mohri`},grid:16,mouse:.12,strength:.15,relaxation:.9,hoverMultiplier:1.5,background:`transparent`,dprCap:2,className:`about-image-media`})}),(0,Z.jsxs)(`div`,{className:`about-copy`,children:[(0,Z.jsx)(`p`,{children:`Parisa Mohri is a creative storyteller working across design, motion, voice, and sound. She builds experiences with emotion and intention, turning ideas into visual identities, animated moments, and immersive digital systems.`}),(0,Z.jsxs)(`div`,{className:`about-contact`,children:[(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`mailto:Parisa@mohri.org`,"data-text":`Email: Parisa@mohri.org`,children:`Email: Parisa@mohri.org`}),(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`|`}),(0,Z.jsx)(`span`,{className:`glitch-hover`,"data-text":`Toronto, ON`,children:`Toronto, ON`})]})]})]})}var Uc=[`UI/UX — Mobile & Web Design — Branding`,`Graphic Design — Art Direction.`];function Wc(){return(0,Z.jsxs)(`section`,{className:`skills-section`,"aria-labelledby":`skills-title`,children:[(0,Z.jsxs)(`p`,{className:`section-label`,id:`skills-title`,children:[`Skills `,(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`>`})]}),(0,Z.jsx)(`div`,{className:`skills-list`,children:Uc.map(e=>(0,Z.jsx)(`p`,{children:e},e))})]})}var Gc=()=>new Intl.DateTimeFormat(`en-US`,{timeZone:`America/Toronto`,hour:`2-digit`,minute:`2-digit`,hour12:!0}).format(new Date),Kc=[`Dribbble`,`Behance`,`LinkedIn`,`X`];function qc(){let[e,t]=(0,_.useState)(Gc);return(0,_.useEffect)(()=>{let e=window.setInterval(()=>t(Gc()),6e4);return()=>window.clearInterval(e)},[]),(0,Z.jsxs)(`footer`,{className:`contact-section`,id:`contact`,"aria-label":`Contact`,children:[(0,Z.jsxs)(`div`,{className:`footer-main`,children:[(0,Z.jsx)(`div`,{className:`footer-message`,children:(0,Z.jsxs)(`h2`,{children:[`Let’s create`,(0,Z.jsx)(`br`,{}),`something great`,(0,Z.jsx)(`br`,{}),`together.`]})}),(0,Z.jsxs)(`div`,{className:`footer-cta`,children:[(0,Z.jsxs)(`a`,{className:`email-link`,href:`mailto:Parisa@mohri.org`,children:[(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`→`}),(0,Z.jsx)(`span`,{className:`glitch-hover`,"data-text":`SEND ME AN EMAIL`,children:`Send me an email`})]}),(0,Z.jsxs)(`p`,{className:`local-time`,children:[`Local time `,(0,Z.jsx)(`span`,{"aria-hidden":`true`,children:`▸`}),` `,(0,Z.jsx)(`strong`,{children:e})]})]})]}),(0,Z.jsxs)(`div`,{className:`footer-bottom`,children:[(0,Z.jsx)(`a`,{className:`footer-mark glitch-hover`,href:`#home`,"aria-label":`Back to top`,"data-text":`PM`,children:`PM`}),(0,Z.jsx)(`nav`,{className:`footer-socials`,"aria-label":`Footer social links`,children:Kc.map(e=>(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`#home`,"data-text":e,children:e},e))}),(0,Z.jsxs)(`div`,{className:`footer-credit`,children:[(0,Z.jsx)(`p`,{children:`© 2026 Parisa Mohri`}),(0,Z.jsx)(`p`,{children:`Made with ♥ by Parisa Mohri.`})]})]})]})}var Jc=e=>`/parisa-mohri-portfolio/images/${e}`,Yc=[{title:`Bloom`,number:`01`,category:`Product Design — UX/UI`,image:Jc(`bloom.png`),aspectRatio:`1122 / 1402`},{title:`Glitch`,number:`02`,category:`Packaging Design — Visual System`,image:Jc(`glitch-energy.png`),aspectRatio:`1122 / 1402`},{title:`Naturecycle`,number:`03`,category:`Product Design — Sustainable Beauty`,image:Jc(`naturecycle.png`),aspectRatio:`1491 / 1055`},{title:`Warby Parker`,number:`04`,category:`Campaign Design — Art Direction`,image:Jc(`warby-parker.png`),aspectRatio:`1672 / 941`}];function Xc({project:e,index:t,assembled:n}){return(0,Z.jsxs)(`article`,{className:`project-card project-card-${t+1}`,children:[(0,Z.jsx)(`div`,{className:`project-image-wrap`,style:{aspectRatio:e.aspectRatio},children:(0,Z.jsx)(Bc,{mediaType:`image`,image:{src:e.image,alt:e.title},grid:16,mouse:.12,strength:.15,relaxation:.9,hoverMultiplier:1.5,background:`transparent`,dprCap:2,assemble:n,className:`project-card-media`})}),(0,Z.jsxs)(`div`,{className:`project-info`,children:[(0,Z.jsxs)(`div`,{className:`project-meta`,children:[(0,Z.jsxs)(`span`,{children:[`Project /`,e.number]}),(0,Z.jsx)(`span`,{children:e.category})]}),(0,Z.jsxs)(`div`,{className:`project-title-row`,children:[(0,Z.jsx)(`h3`,{className:`glitch-hover`,"data-text":e.title,children:e.title}),(0,Z.jsx)(`span`,{className:`project-arrow`,"aria-hidden":`true`,children:`→`})]})]})]})}function Zc(){let e=(0,_.useRef)(null),[t,n]=(0,_.useState)(()=>typeof window<`u`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches);return(0,_.useEffect)(()=>{if(t)return;let r=e.current;if(!r)return;let i=new IntersectionObserver(([e])=>{e.isIntersecting&&(n(!0),i.disconnect())},{threshold:.08,rootMargin:`0px 0px -12% 0px`});return i.observe(r),()=>i.disconnect()},[t]),(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(Vc,{}),(0,Z.jsxs)(`main`,{className:`site-shell`,children:[(0,Z.jsxs)(`nav`,{className:`topbar`,"aria-label":`Primary navigation`,children:[(0,Z.jsx)(`a`,{className:`nav-name glitch-hover`,href:`#home`,"aria-label":`Parisa Mohri home`,"data-text":`— PARISA MOHRI`,children:`— Parisa Mohri`}),(0,Z.jsx)(`a`,{className:`nav-mark glitch-hover`,href:`#home`,"aria-label":`Back to top`,"data-text":`PM`,children:`PM`}),(0,Z.jsxs)(`div`,{className:`nav-links`,children:[(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`#work`,"data-text":`Work`,children:`Work`}),(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`#profile`,"data-text":`Profile`,children:`Profile`}),(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`#contact`,"data-text":`Contact`,children:`Contact`}),(0,Z.jsx)(`a`,{className:`nav-email glitch-hover`,href:`mailto:Parisa@mohri.org`,"data-text":`Email me`,children:`Email me`})]})]}),(0,Z.jsxs)(`section`,{className:`hero-section`,id:`home`,children:[(0,Z.jsxs)(`div`,{className:`hero-meta`,"aria-label":`Designer details`,children:[(0,Z.jsx)(`span`,{children:`Independent designer`}),(0,Z.jsx)(`span`,{children:`Based in Canada`}),(0,Z.jsx)(`p`,{children:`Digital designer crafting identities, interfaces, and visual systems with clarity, atmosphere, and a cinematic edge.`})]}),(0,Z.jsxs)(`h1`,{className:`hero-title`,children:[(0,Z.jsx)(`span`,{children:`Parisa Mohri`}),(0,Z.jsx)(`strong`,{children:`Digital Designer`})]}),(0,Z.jsxs)(`div`,{className:`hero-baseline`,children:[(0,Z.jsx)(`span`,{children:`Selected work / 2026`}),(0,Z.jsxs)(`div`,{className:`hero-socials`,"aria-label":`Social profiles`,children:[(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`#contact`,"data-text":`Behance`,children:`Behance`}),(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`#contact`,"data-text":`LinkedIn`,children:`LinkedIn`}),(0,Z.jsx)(`a`,{className:`glitch-hover`,href:`https://www.instagram.com/paris_azhdehfar/`,"data-text":`Instagram`,target:`_blank`,rel:`noreferrer`,children:`Instagram`})]})]})]}),(0,Z.jsx)(Hc,{image:Jc(`parisa-about.png`)}),(0,Z.jsx)(Wc,{}),(0,Z.jsxs)(`section`,{className:`work-section`,id:`work`,ref:e,"data-assembled":t,children:[(0,Z.jsxs)(`div`,{className:`section-heading`,children:[(0,Z.jsx)(`p`,{className:`eyebrow`,children:`Selected work`}),(0,Z.jsx)(`h2`,{children:`Quiet interfaces with a cinematic edge.`})]}),(0,Z.jsx)(`div`,{className:`projects-layout`,children:Yc.map((e,n)=>(0,Z.jsx)(Xc,{project:e,index:n,assembled:t},e.title))})]}),(0,Z.jsx)(qc,{})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(_.StrictMode,{children:(0,Z.jsx)(Zc,{})}));